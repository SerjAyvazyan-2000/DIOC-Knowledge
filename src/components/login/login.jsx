...
const Login = ({close, active}) => {
    ...
    const handleSubmit = (e) => {
        ...
        let newErrors = {
            ...
            password: validatePassword(formData.password) ? "" : "Пароль должен быть от 6 символов",
        };
            ...
            {!reset ? <>
                ...
                <form className='auth-form' action="">
                    ...
                    <div className='remember-block G-justify-between'>
                        ...
                        <button onClick={handleReset} className='forgot-password'>Забыли пароль?</button>

                    </div>
                    <div className='form-btn-cnt G-align-start'>
                        <button onClick={handleSubmit} className='btn-primary'>Войти</button>
                    </div>
